...
public class encryption 
{
  ...
  /**
    *The list of transposition keys. 
    */
  ...
  /**
    ...
    */
  public encryption(int privateKey) 
  {
    int keyIndex = (privateKey % SUBSTITUTION_KEYS.length);
    this.substitutionScheme = 
    new SubstitutionScheme(SUBSTITUTION_KEYS[keyIndex]);
    this.transpositionScheme = 
    new TranspositionScheme(TRANSPOSITION_KEYS[keyIndex]);
  }
